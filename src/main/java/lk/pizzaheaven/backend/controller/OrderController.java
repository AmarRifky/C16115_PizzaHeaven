package lk.pizzaheaven.backend.controller;
...
import lk.pizzaheaven.backend.entity.enums.CheeseType;
import lk.pizzaheaven.backend.entity.enums.CrustType;
import lk.pizzaheaven.backend.entity.enums.DeliveryType;
import lk.pizzaheaven.backend.entity.enums.OrderStatus;
import lk.pizzaheaven.backend.entity.enums.PaymentType;
import lk.pizzaheaven.backend.entity.enums.SauceType;
import lk.pizzaheaven.backend.entity.enums.ToppingsType;
import lk.pizzaheaven.backend.service.OrderService;
import lk.pizzaheaven.backend.service.OrderServiceImpl;
import lk.pizzaheaven.backend.service.PizzaService;
import lk.pizzaheaven.backend.service.PizzaServiceImpl;
import lk.pizzaheaven.backend.service.UserService;
import lk.pizzaheaven.backend.service.UserServiceImpl;
import lk.pizzaheaven.backend.service.strategy.CreditCardPayment;
import lk.pizzaheaven.backend.service.strategy.DigitalWalletPayment;
...
public class OrderController {
    ...
    public void startApp() {
        System.out.println("╔═══════════════════════════════════════════════╗");
        System.out.println("║  Welcome to Pizza Heaven Ordering System      ║");
        System.out.println("╚═══════════════════════════════════════════════╝");
        start();
    }
    ...
    private void addPizzaToFavorites(PizzaEntity customizedPizza) {
        ...
        try {
            // Create a Favourite pizza Entity
